...
### Added
- Поддержка BLE
- Подписка на BLE Battery Service (BAS)
- Настройки Wi-Fi/SSID для модуля
- Открытие системных настроек доступности из экрана настроек
- Поддержка Linux

### Changed
- Переработаны настройки модуля и экран module_settings (включая поле ввода пароля)

### Fixed
- Сообщение при отсутствии TTS
- Добавлен символ "№" в легенду столбца
- Мелкие UI/UX улучшения
- Подключение к Bluetooth стало неблокирующим (можно отменить во время подключения)
- Убрано переполнение блока RSSI в списке устройств
...
## [0.5.2] - 2026-07-29
### Fixed
- Исправлена ошибка с повторяющимися номерами на финише

## [0.5.1] - 2025-05-23
При использовании автоматической отсечки, теперь есть возможность не учитывать от неё данные времени, а использовать вместо этого время получения её на смартфоне. Либо быстро заменить отдельные значения автоматической поправки на поправку относительно времени смартфона. Может быть актуально при сбое или не настроенном времени в отсечке.
...
- Добавлена возможность быстро заменить автоматическую поправку на поправку относительно времени смартфона
...
[Unreleased]: https://github.com/Syutkin/entime-mobile/compare/0.5.2...HEAD
