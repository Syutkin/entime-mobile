...
### Added
- Добавлена поддержка импорта стартового протокола всего соревнования
...
- Добавлена индикация разницы финишного времени между временем модуля и временем устройства
