...
class SettingsState extends Equatable {
  ...
  SettingsState({
    ...
    @required this.log_limit,
      ...
      : assert(sound != null),
        ...
        assert(startFab != null),
        assert(startFabSize != null),
        assert(finishFab != null),
        assert(finishFabSize != null),
        assert(countdown != null),
        assert(countdownSize != null),
        assert(checkUpdates != null),
        assert(hideMarked != null),
        assert(hideNumbers != null),
        assert(hideManual != null),
        assert(reconnect != null),
        assert(finishDelay != null),
        assert(substituteNumbers != null),
        assert(substituteNumbersDelay != null),
        assert(log_limit != null);
  ...
  SettingsState.clone(SettingsState state, {
    bool sound,
    bool beep,
    bool voice,
    bool voice_name,
