...
class ModuleSettingsBleInitScreen extends StatelessWidget {
  ModuleSettingsBleInitScreen({
    Key? key,
  }) : super(key: key);
      ...
      await showDialog(
          ...
          builder: (context) => AlertDialog(
                ...
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
                      BlocProvider.of<BleInteractorBloc>(context)
                          .add(BleInteractorWriteSettings(
                        deviceId: BlocProvider.of<BleConnectorBloc>(context)
                            .state
                            .bleSelectedDevice!
                            .id,
                        settings: BlocProvider.of<ModuleSettingsBloc>(context)
                            .moduleSettings
                            .write,
                      ));
...
// class ModuleSettingsBleScreen extends StatelessWidget {
//   final VoidCallback onChanged;
//
//   ModuleSettingsBleScreen({
//     Key? key,
