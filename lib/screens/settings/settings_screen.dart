        ...
        sections: [
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile.switchTile(
                title: 'Восстанавливать соединение с модулем при обрыве связи',
                leading: const Icon(Icons.bluetooth),
            ...
            tiles: [
              ...
              SettingsTile(
                ...
                onPressed: (BuildContext context) async {
                  ...
                  if (value != null) {
                    settingsBloc.add(SetDoubleValueEvent(countdownSize: value));
                  }
                },
              ),
              SettingsTile.switchTile(
              ...
              SettingsTile(
                ...
                onPressed: (BuildContext context) async {
                  ...
                  if (value != null) {
                    settingsBloc.add(SetDoubleValueEvent(startFabSize: value));
                  }
                },
              ),
            ],
          ...
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile.switchTile(
                ...
                onToggle: (bool value) {
                  settingsBloc.add(SetBoolValueEvent(substituteNumbers: value));
                },
              ),
              SettingsTile(
                title:
              ...
              SettingsTile(
                ...
                onPressed: (BuildContext context) async {
                  ...
                  if (value != null) {
                    settingsBloc.add(SetDoubleValueEvent(finishFabSize: value));
                  }
                },
              ),
            ],
