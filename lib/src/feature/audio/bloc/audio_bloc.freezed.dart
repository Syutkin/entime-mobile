...
abstract class _Init implements AudioEvent {
...
class _$InitializedImpl implements _Initialized {
  const _$InitializedImpl({this.engine, this.voice});
  ...
  TResult when<TResult extends Object?>({
    ...
    return initialized(engine, voice);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return initialized?.call(engine, voice);
  }
...
abstract class _Initialized implements AudioState {
  const factory _Initialized({final String? engine, final String? voice}) =
      _$InitializedImpl;
