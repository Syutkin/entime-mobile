...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AudioStateInitial value)?  initial,TResult Function( AudioStateInitialized value)?  initialized,required TResult orElse(),}){
final _that = this;
switch (_that) {
case AudioStateInitial() when initial != null:
return initial(_that);case AudioStateInitialized() when initialized != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AudioStateInitial value)  initial,required TResult Function( AudioStateInitialized value)  initialized,}){
final _that = this;
switch (_that) {
case AudioStateInitial():
return initial(_that);case AudioStateInitialized():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AudioStateInitial value)?  initial,TResult? Function( AudioStateInitialized value)?  initialized,}){
final _that = this;
switch (_that) {
case AudioStateInitial() when initial != null:
return initial(_that);case AudioStateInitialized() when initialized != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( String? engine,  String? voice)?  initialized,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AudioStateInitial() when initial != null:
return initial();case AudioStateInitialized() when initialized != null:
return initialized(_that.engine,_that.voice);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( String? engine,  String? voice)  initialized,}) {final _that = this;
switch (_that) {
case AudioStateInitial():
return initial();case AudioStateInitialized():
return initialized(_that.engine,_that.voice);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( String? engine,  String? voice)?  initialized,}) {final _that = this;
switch (_that) {
case AudioStateInitial() when initial != null:
return initial();case AudioStateInitialized() when initialized != null:
return initialized(_that.engine,_that.voice);case _:
