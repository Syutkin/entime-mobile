...
@pragma('vm:prefer-inline') @override $Res call({Object? lookUpAddress = freezed,Object? port = freezed,Object? timeout = freezed,Object? cacheDuration = freezed,}) {
  return _then(NtpEvent.getNtpOffset(
...
/// Adds pattern-matching-related methods to [NtpEvent].
extension NtpEventPatterns on NtpEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GetNtpOffset value)?  getNtpOffset,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetNtpOffset() when getNtpOffset != null:
return getNtpOffset(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GetNtpOffset value)  getNtpOffset,}){
final _that = this;
switch (_that) {
case _GetNtpOffset():
return getNtpOffset(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GetNtpOffset value)?  getNtpOffset,}){
final _that = this;
switch (_that) {
case _GetNtpOffset() when getNtpOffset != null:
return getNtpOffset(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? lookUpAddress,  int? port,  Duration? timeout,  Duration? cacheDuration)?  getNtpOffset,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetNtpOffset() when getNtpOffset != null:
return getNtpOffset(_that.lookUpAddress,_that.port,_that.timeout,_that.cacheDuration);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? lookUpAddress,  int? port,  Duration? timeout,  Duration? cacheDuration)  getNtpOffset,}) {final _that = this;
switch (_that) {
case _GetNtpOffset():
return getNtpOffset(_that.lookUpAddress,_that.port,_that.timeout,_that.cacheDuration);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? lookUpAddress,  int? port,  Duration? timeout,  Duration? cacheDuration)?  getNtpOffset,}) {final _that = this;
switch (_that) {
case _GetNtpOffset() when getNtpOffset != null:
return getNtpOffset(_that.lookUpAddress,_that.port,_that.timeout,_that.cacheDuration);case _:
  return null;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int offset)?  initial,TResult Function( int offset)?  loading,TResult Function( int offset)?  success,TResult Function( int offset)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial(_that.offset);case Loading() when loading != null:
return loading(_that.offset);case Success() when success != null:
return success(_that.offset);case Failure() when failure != null:
return failure(_that.offset);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int offset)  initial,required TResult Function( int offset)  loading,required TResult Function( int offset)  success,required TResult Function( int offset)  failure,}) {final _that = this;
switch (_that) {
case Initial():
return initial(_that.offset);case Loading():
return loading(_that.offset);case Success():
return success(_that.offset);case Failure():
return failure(_that.offset);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int offset)?  initial,TResult? Function( int offset)?  loading,TResult? Function( int offset)?  success,TResult? Function( int offset)?  failure,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial(_that.offset);case Loading() when loading != null:
return loading(_that.offset);case Success() when success != null:
