...
return updateStartingInfo(_that);case _SetStartTime() when setStartTime != null:
return setStartTime(_that);case _UpdateAutomaticCorrection() when updateAutomaticCorrection != null:
...
return updateStartingInfo(_that);case _SetStartTime():
return setStartTime(_that);case _UpdateAutomaticCorrection():
...
return updateStartingInfo(_that.stageId,_that.participantId,_that.startTime,_that.timestampCorrection,_that.automaticStartTime,_that.automaticCorrection,_that.manualStartTime,_that.manualCorrection);case _SetStartTime() when setStartTime != null:
return setStartTime(_that.stageId,_that.participantId,_that.number,_that.startTime,_that.forceUpdate);case _UpdateAutomaticCorrection() when updateAutomaticCorrection != null:
...
return updateStartingInfo(_that.stageId,_that.participantId,_that.startTime,_that.timestampCorrection,_that.automaticStartTime,_that.automaticCorrection,_that.manualStartTime,_that.manualCorrection);case _SetStartTime():
return setStartTime(_that.stageId,_that.participantId,_that.number,_that.startTime,_that.forceUpdate);case _UpdateAutomaticCorrection():
...
class _UpsertStage with DiagnosticableTreeMixin implements DatabaseEvent {
  const _UpsertStage({this.id, this.name, this.description, this.raceId, this.trailId, this.isActive, this.deletedAt, this.removeTrailId = false});
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('name', name))..add(DiagnosticsProperty('description', description))..add(DiagnosticsProperty('raceId', raceId))..add(DiagnosticsProperty('trailId', trailId))..add(DiagnosticsProperty('isActive', isActive))..add(DiagnosticsProperty('deletedAt', deletedAt))..add(DiagnosticsProperty('removeTrailId', removeTrailId));
}
...
@override
int get hashCode => Object.hash(runtimeType,id,name,description,raceId,trailId,isActive,deletedAt,removeTrailId);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'DatabaseEvent.upsertStage(id: $id, name: $name, description: $description, raceId: $raceId, trailId: $trailId, isActive: $isActive, deletedAt: $deletedAt, removeTrailId: $removeTrailId)';
}
...
@useResult
$Res call({
 int? id, String? name, String? description, int? raceId, int? trailId, bool? isActive, DateTime? deletedAt, bool removeTrailId
});
...
/// Create a copy of DatabaseEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? description = freezed,Object? raceId = freezed,Object? trailId = freezed,Object? isActive = freezed,Object? deletedAt = freezed,Object? removeTrailId = null,}) {
...
as DateTime?,removeTrailId: null == removeTrailId ? _self.removeTrailId : removeTrailId // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _UpdateRider with DiagnosticableTreeMixin implements DatabaseEvent {
  const _UpdateRider({required this.riderId, required this.name, this.nickname, this.birthday, this.team, this.city, this.email, this.phone, this.comment, this.deletedAt});
...
@override
int get hashCode => Object.hash(runtimeType,riderId,name,nickname,birthday,team,city,email,phone,comment,deletedAt);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'DatabaseEvent.updateRider(riderId: $riderId, name: $name, nickname: $nickname, birthday: $birthday, team: $team, city: $city, email: $email, phone: $phone, comment: $comment, deletedAt: $deletedAt)';
}
...
@useResult
$Res call({
 int riderId, String name, String? nickname, String? birthday, String? team, String? city, String? email, String? phone, String? comment, DateTime? deletedAt
});
...
/// Create a copy of DatabaseEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? riderId = null,Object? name = null,Object? nickname = freezed,Object? birthday = freezed,Object? team = freezed,Object? city = freezed,Object? email = freezed,Object? phone = freezed,Object? comment = freezed,Object? deletedAt = freezed,}) {
...
class _UpdateStartingInfo with DiagnosticableTreeMixin implements DatabaseEvent {
  const _UpdateStartingInfo({required this.stageId, required this.participantId, required this.startTime, this.timestampCorrection = const Value<int?>.absent(), this.automaticStartTime = const Value<String?>.absent(), this.automaticCorrection = const Value<int?>.absent(), this.manualStartTime = const Value<String?>.absent(), this.manualCorrection = const Value<int?>.absent()});
  

 final  int stageId;
 final  int participantId;
 final  String startTime;
@JsonKey() final  Value<int?> timestampCorrection;
@JsonKey() final  Value<String?> automaticStartTime;
@JsonKey() final  Value<int?> automaticCorrection;
@JsonKey() final  Value<String?> manualStartTime;
@JsonKey() final  Value<int?> manualCorrection;
...
@useResult
$Res call({
 int stageId, int participantId, String startTime, Value<int?> timestampCorrection, Value<String?> automaticStartTime, Value<int?> automaticCorrection, Value<String?> manualStartTime, Value<int?> manualCorrection
});
...
/// Create a copy of DatabaseEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? stageId = null,Object? participantId = null,Object? startTime = null,Object? timestampCorrection = null,Object? automaticStartTime = null,Object? automaticCorrection = null,Object? manualStartTime = null,Object? manualCorrection = null,}) {
  return _then(_UpdateStartingInfo(
stageId: null == stageId ? _self.stageId : stageId // ignore: cast_nullable_to_non_nullable
as int,participantId: null == participantId ? _self.participantId : participantId // ignore: cast_nullable_to_non_nullable
as int,startTime: null == startTime ? _self.startTime : startTime // ignore: cast_nullable_to_non_nullable
as String,timestampCorrection: null == timestampCorrection ? _self.timestampCorrection : timestampCorrection // ignore: cast_nullable_to_non_nullable
as Value<int?>,automaticStartTime: null == automaticStartTime ? _self.automaticStartTime : automaticStartTime // ignore: cast_nullable_to_non_nullable
as Value<String?>,automaticCorrection: null == automaticCorrection ? _self.automaticCorrection : automaticCorrection // ignore: cast_nullable_to_non_nullable
as Value<int?>,manualStartTime: null == manualStartTime ? _self.manualStartTime : manualStartTime // ignore: cast_nullable_to_non_nullable
as Value<String?>,manualCorrection: null == manualCorrection ? _self.manualCorrection : manualCorrection // ignore: cast_nullable_to_non_nullable
as Value<int?>,
  ));
}
...
class _SetStartTime with DiagnosticableTreeMixin implements DatabaseEvent {
  const _SetStartTime({required this.stageId, required this.participantId, required this.number, required this.startTime, this.forceUpdate = false});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SetStartTimeCopyWith<_SetStartTime> get copyWith => __$SetStartTimeCopyWithImpl<_SetStartTime>(this, _$identity);


@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'DatabaseEvent.setStartTime'))
    ..add(DiagnosticsProperty('stageId', stageId))..add(DiagnosticsProperty('participantId', participantId))..add(DiagnosticsProperty('number', number))..add(DiagnosticsProperty('startTime', startTime))..add(DiagnosticsProperty('forceUpdate', forceUpdate));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SetStartTime&&(identical(other.stageId, stageId) || other.stageId == stageId)&&(identical(other.participantId, participantId) || other.participantId == participantId)&&(identical(other.number, number) || other.number == number)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.forceUpdate, forceUpdate) || other.forceUpdate == forceUpdate));
}


@override
int get hashCode => Object.hash(runtimeType,stageId,participantId,number,startTime,forceUpdate);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'DatabaseEvent.setStartTime(stageId: $stageId, participantId: $participantId, number: $number, startTime: $startTime, forceUpdate: $forceUpdate)';
}
...
/// @nodoc
abstract mixin class _$SetStartTimeCopyWith<$Res> implements $DatabaseEventCopyWith<$Res> {
  factory _$SetStartTimeCopyWith(_SetStartTime value, $Res Function(_SetStartTime) _then) = __$SetStartTimeCopyWithImpl;
@useResult
$Res call({
 int stageId, int participantId, int number, String startTime, bool forceUpdate
});
...
class __$SetStartTimeCopyWithImpl<$Res>
  ...
  __$SetStartTimeCopyWithImpl(this._self, this._then);

  final _SetStartTime _self;
  final $Res Function(_SetStartTime) _then;

/// Create a copy of DatabaseEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? stageId = null,Object? participantId = null,Object? number = null,Object? startTime = null,Object? forceUpdate = null,}) {
  return _then(_SetStartTime(
stageId: null == stageId ? _self.stageId : stageId // ignore: cast_nullable_to_non_nullable
as int,participantId: null == participantId ? _self.participantId : participantId // ignore: cast_nullable_to_non_nullable
