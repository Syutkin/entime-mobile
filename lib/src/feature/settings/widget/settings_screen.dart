...
// value ?  ?
                    ...
                    SettingsTile.switchTile(
                      ...
                      description: Text(Localization
                          .current.I18nSettings_reconnectDescription),
                      // subtitleMaxLines: 3,
                      //leading:  Icon(Icons.bluetooth),
                  ...
                  tiles: [
                    ...
                    SettingsTile(
                      ...
                      onPressed: (context) async {
                        final value =
                            await setVolumePopup(context, settingsState);
                        if (value != null) {
                          settingsBloc.add(SettingsEventUpdate(
                              settings: settingsState.settings
                    ...
                    SettingsTile(
                      ...
                      onPressed: (context) async {
                        final value =
                            await setPitchPopup(context, settingsState);
                        if (value != null) {
                          settingsBloc.add(SettingsEventUpdate(
                              settings: settingsState.settings
                    ...
                    SettingsTile(
                      ...
                      onPressed: (context) async {
                        final value =
                            await setRatePopup(context, settingsState);
                        if (value != null) {
                          settingsBloc.add(SettingsEventUpdate(
                              settings: settingsState.settings
                                  .copyWith(rate: value)));
                ...
                SettingsSection(
                  ...
                  tiles: [
                    ...
                    SettingsTile.switchTile(
                      title: Text(Localization
                          .current.I18nSettings_replaceStartCountdown),
                      // titleMaxLines: 2,
                      //leading:  Icon(MdiIcons.timer),
                ...
                SettingsSection(
                  ...
                  tiles: [
                    SettingsTile(
                      ...
                      onPressed: (context) async {
                        final value = await setDelayPopup(
                            ...
                            settingsState.settings.finishDelay,
                            Localization
                                .current.I18nSettings_delayForNewEvents);
                        if (value != null) {
                          settingsBloc.add(SettingsEventUpdate(
                              settings: settingsState.settings
                    ...
                    SettingsTile.switchTile(
                      title:
                          Text(Localization.current.I18nSettings_finishButton),
                      //leading:  Icon(MdiIcons.handBackLeft),
                      initialValue: settingsState.settings.finishFab,
                      onToggle: (value) {
                        settingsBloc.add(SettingsEventUpdate(
                            settings: settingsState.settings
                                .copyWith(finishFab: value)));
                      },
                    ),
                    SettingsTile(
                      title: Text(
                ...
                SettingsSection(
                  ...
                  tiles: [
                    SettingsTile.switchTile(
                      title: Text(Localization
                          .current.I18nSettings_checkUpdateAtStartup),
                      // titleMaxLines: 2,
