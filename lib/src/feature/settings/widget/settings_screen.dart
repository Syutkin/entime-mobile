          ...
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile(
                ...
                //leading:  Icon(Icons.volume_up),
                trailing: Text(
                  '${(settingsState.volume * 100).round()}%',
                ),
              ...
              SettingsTile(
                ...
                trailing: Text(
                  settingsState.pitch.toStringAsFixed(2),
                ),
                onPressed: (context) async {
              ...
              SettingsTile(
                ...
                trailing: Text(
                  settingsState.rate.toStringAsFixed(2),
                ),
                onPressed: (context) async {
              ...
              SettingsTile(
                ...
                trailing: Text(
                  Localization.current.I18nSettings_milliseconds(
                    settingsState.startDifferenceThreshold,
                  ),
                ),
                //leading:  Icon(MdiIcons.handBackLeft),
                onPressed: (context) async {
          ...
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile(
                ...
                trailing: Text(
                  Localization.current.I18nSettings_milliseconds(
                    settingsState.finishDifferenceThreshold,
                  ),
                ),
                //leading:  Icon(MdiIcons.handBackLeft),
                onPressed: (context) async {
