                ...
                onOkPressed: () {
                  BlocProvider.of<BluetoothBloc>(context).add(
                    BluetoothEvent.sendMessage(
                      message: BlocProvider.of<ModuleSettingsBloc>(context).moduleSettings.write,
                    ),
                  );
                  // ToDo: зачем тут contex? и передача одинаковых значений в Navigator.pop
                  Navigator.pop(context, true);
  ...
  Widget build(BuildContext context) {
    ...
    if (bloc.moduleSettings.type == 'entime') {
      return BlocBuilder<ModuleSettingsBloc, ModuleSettingsState>(
        builder:
            (context, state) => SettingsList(
              sections: [
                SettingsSection(
                  title: Text(Localization.current.I18nModuleSettings_module),
                  tiles: [
                    SettingsTile(
                      title: Text('${bloc.moduleSettings.bluetoothName}${bloc.moduleSettings.bluetoothNumber}'),
                    ),
                  ],
                ),
                SettingsSection(
                ...
                SettingsSection(
                  ...
                  tiles: [
                    ...
                    SettingsTile(
                      ...
                      trailing: Text(
                        Localization.current.I18nModuleSettings_frequencyHz(bloc.moduleSettings.frequency),
                      ),
                      //leading:  Icon(MdiIcons.wave),
                      onPressed: (context) {
                        onChanged();
