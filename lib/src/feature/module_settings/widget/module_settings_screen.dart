          ...
          actions: cancelOkButtons(
            ...
            onOkPressed: () {
              BlocProvider.of<BluetoothBloc>(context).add(
                BluetoothEvent.sendMessage(message: BlocProvider.of<ModuleSettingsBloc>(context).moduleSettings.write),
              );
              // ToDo: зачем тут contex? и передача одинаковых значений в Navigator.pop
              Navigator.pop(context, true);
            },
...
class ModuleSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (bloc.moduleSettings.type == 'entime') {
        ...
        builder: (context, state) => SettingsList(
          sections: [
            SettingsSection(
              ...
              tiles: [
                SettingsTile(title: Text('${bloc.moduleSettings.bluetoothName}${bloc.moduleSettings.bluetoothNumber}')),
              ],
            ),
            SettingsSection(
              ...
              tiles: [
                ...
                SettingsTile(
                  ...
                  trailing: Text(
                    Localization.current.I18nModuleSettings_frequencyHz(bloc.moduleSettings.shortFrequency),
                  ),
                ...
                SettingsTile(
                  ...
                  trailing: Text(
                    Localization.current.I18nModuleSettings_frequencyHz(bloc.moduleSettings.longFrequency),
                  ),
                  //leading:  Icon(MdiIcons.wave),
                  onPressed: (context) async {
                    final hz = await buzzerFrequencyPopup(
            ...
            SettingsSection(
              ...
              tiles: [
                ...
                SettingsTile(
                  ...
                  trailing: Text(Localization.current.I18nModuleSettings_frequencyHz(bloc.moduleSettings.frequency)),
                  //leading:  Icon(MdiIcons.wave),
                  enabled: false,
                  onPressed: (context) {
                    onChanged();
            ...
            SettingsSection(
              ...
              tiles: [
                ...
                SettingsTile(
                  title: Text(Localization.current.I18nModuleSettings_sleepMode),
                  trailing: Text(
                    Localization.current.I18nModuleSettings_sleepModeSeconds(bloc.moduleSettings.timeoutDuration),
                  ),
                  //leading:  Icon(MdiIcons.monitor),
                  enabled: false,
                  onPressed: (context) {
                ...
                SettingsTile(
                  ...
                  onPressed: (context) async {
                    final password = await wifiSettingsPopup(
                      ...
                      text: Localization.current.I18nModuleSettings_enterWifiPassword(bloc.moduleSettings.ssid),
                    );
                    if (password != null) {
                      onChanged();
            ...
            SettingsSection(
              ...
              tiles: [
                SettingsTile(
                  ...
                  trailing: Text(Localization.current.I18nModuleSettings_resistorOhm(bloc.moduleSettings.r1)),
                ...
                SettingsTile(
                  ...
                  trailing: Text(Localization.current.I18nModuleSettings_resistorOhm(bloc.moduleSettings.r2)),
                  //leading:  Icon(MdiIcons.resistor),
                  onPressed: (context) async {
      ...
      return Splash(text: Localization.current.I18nModuleSettings_unknownModuleType(bloc.moduleSettings.type));
    }
  }
}
