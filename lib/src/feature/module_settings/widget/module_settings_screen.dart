                ...
                onOkPressed: () {
                  BlocProvider.of<BluetoothBloc>(context).add(
                    BluetoothEvent.sendMessage(
                      message:
                          BlocProvider.of<ModuleSettingsBloc>(
                            context,
              ...
              sections: [
                ...
                SettingsSection(
                  ...
                  tiles: [
                    SettingsTile.switchTile(
                      title: Text(
                        Localization.current.I18nModuleSettings_buzzer,
                      ),
                ...
                SettingsSection(
                  ...
                  tiles: [
                    ...
                    SettingsTile(
                      title: Text(
                        Localization.current.I18nModuleSettings_txPower,
                      ),
                    ...
                    SettingsTile(
                      ...
                      trailing: Text(
                        '${bloc.moduleSettings.codingRateDenominator}',
                      ),
                      //leading:  Icon(MdiIcons.wave),
                      onPressed: (context) {
                        onChanged();
                    ...
                    SettingsTile(
                      ...
                      onPressed: (context) async {
                        final r1 = await vccPopup(
                          context: context,
                          labelText:
                              Localization.current.I18nModuleSettings_ohm,
                          text:
                              Localization
                                  .current
                ...
                SettingsSection(
                  ...
                  tiles: [
                    ...
                    SettingsTile(
                      ...
                      description: Text(
                        '${bloc.moduleSettings.bluetoothNumber}',
                      ),
                      //leading:  Icon(MdiIcons.bluetooth),
                      onPressed: (context) async {
                        final number = await bluetoothNumberPopup(
                    ...
                    SettingsTile(
                      ...
                      onPressed: (context) async {
                        final ssid = await wifiSettingsPopup(
                          context: context,
                          labelText:
                              Localization.current.I18nModuleSettings_wifi,
                          text:
                              Localization
                                  .current
