...
_GpsSettings _$GpsSettingsFromJson(Map<String, dynamic> json) => _GpsSettings(enabled: json['enabled'] as bool);

Map<String, dynamic> _$GpsSettingsToJson(_GpsSettings instance) => <String, dynamic>{'enabled': instance.enabled};

_TouchSettings _$TouchSettingsFromJson(Map<String, dynamic> json) => _TouchSettings(
  enabled: json['enabled'] as bool,
  calValid: json['cal_valid'] as bool,
  calibration: (json['calibration'] as List<dynamic>).map((e) => (e as num).toInt()).toList(),
);

Map<String, dynamic> _$TouchSettingsToJson(_TouchSettings instance) => <String, dynamic>{
