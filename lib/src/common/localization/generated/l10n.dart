...
class GeneratedLocalization {
  ...
  /// `Имя сети`
  String get I18nModuleSettings_wifiSsid {
    return Intl.message(
      'Имя сети',
      name: 'I18nModuleSettings_wifiSsid',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Пароль`
  String get I18nModuleSettings_wifiPassword {
    return Intl.message(
      'Пароль',
      name: 'I18nModuleSettings_wifiPassword',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Введите данные сети`
  String get I18nModuleSettings_enterWifiCredentials {
    return Intl.message(
      'Введите данные сети',
