...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(category) => "Category: ${category}";

  static String m21(city) => "City: ${city}";

  static String m22(nickname) => "Nickname: ${nickname}";

  static String m23(number) => "Participant No. ${number}";

  static String m24(number, name) => "No. ${number}, ${name}";

  static String m25(team) => "Team: ${team}";

  static String m26(year) => "Year/Age: ${year}";

  static String m27(current, total) => "${current} from ${total}";

  static String m28(version) => "Update to ${version}";
