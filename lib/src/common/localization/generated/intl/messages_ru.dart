...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(emailLaunchUri) => "Could not launch ${emailLaunchUri}";

  static String m27(version) => "Версия: ${version}";

  static String m28(raceName) => "Вы уверены, что хотите удалить гонку \"${raceName}\"?";

  static String m29(stageName) => "Вы уверены, что хотите удалить этап \"${stageName}\"?";

  static String m30(trailName) => "Вы уверены, что хотите удалить трейл \"${trailName}\"?";
  ...
  static String m8(message) => "Ошибка сохранения настроек: ${message}";

  static String m9(type) => "Неизвестный тип модуля: ${type}";
  ...
  static String m11(number) => "Финишировал номер ${number}";

  static String m12(raceName, stageName) => "Результаты финишей гонки ${raceName}, этап ${stageName}";

  static String m13(raceName, stageName) => "Результаты стартов гонки ${raceName}, этап ${stageName}";

  static String m14(number) => "Участнику с номером ${number} уже присвоено финишное время. Установить новое значение?";

  static String m15(milliseconds) => "${milliseconds}мс";

  static String m16(size) => "${size}px";

  static String m32(seconds) => "${seconds}с";

  static String m17(category) => "Категория: ${category}";

  static String m18(city) => "Город: ${city}";

  static String m19(nickname) => "Никнейм: ${nickname}";

  static String m20(number) => "Участник №${number}";

  static String m21(number, name) => "№${number}, ${name}";

  static String m22(team) => "Команда: ${team}";

  static String m23(year) => "Год/Возраст: ${year}";

  static String m33(automaticCorrection, timestampCorrection) =>
  ...
  static String m34(number) => "Участник с номером ${number} не стартовал?";

  static String m35(number, time) =>
      "Сдвинуть время стартов на указанное количество минут от номера ${number} (время старта ${time}) и далее?";

  static String m24(current, total) => "${current} из ${total}";

  static String m25(version) => "Обновить до ${version}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "I18nDatabase_deleteRace": m28,
    "I18nDatabase_deleteStage": m29,
    ...
    "I18nStart_replaceAutomaticCorrectionConfirmation": m33,
    "I18nStart_setDnsConfirmation": m34,
    ...
    "I18nStart_shiftStartsTimeFromNumber": m35,
