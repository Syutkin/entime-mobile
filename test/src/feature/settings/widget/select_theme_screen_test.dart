...
void main() {
  ...
  group(
    ...
    () {
      ...
      patrolWidgetTest('Tap on PopupMenuButton<ColorSeed>',
          (PatrolTester $) async {
        await $.pumpWidgetAndSettle(testWidget());
      ...
      patrolWidgetTest('Tap on PopupMenuButton<DynamicSchemeVariant>',
          (PatrolTester $) async {
        await $.pumpWidgetAndSettle(testWidget());
      ...
      patrolWidgetTest('Tap on change brightness mode', (PatrolTester $) async {
        final settings =
            const AppSettings.defaults().copyWith(brightness: Brightness.dark);
        await $.pumpWidgetAndSettle(testWidget());
