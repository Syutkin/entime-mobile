...
// in entime/test/src/feature/update/logic/update_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAppInfoProvider extends _i1.Mock implements _i7.AppInfoProvider {
  MockAppInfoProvider() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  List<String?> get deviceSupported32BitAbis => (super.noSuchMethod(
        Invocation.getter(#deviceSupported32BitAbis),
        returnValue: <String?>[],
      ) as List<String?>);

  @override
  List<String?> get deviceSupported64BitAbis => (super.noSuchMethod(
        Invocation.getter(#deviceSupported64BitAbis),
        returnValue: <String?>[],
      ) as List<String?>);

  @override
  List<String?> get deviceSupportedAbis => (super.noSuchMethod(
        Invocation.getter(#deviceSupportedAbis),
        returnValue: <String?>[],
      ) as List<String?>);
}
